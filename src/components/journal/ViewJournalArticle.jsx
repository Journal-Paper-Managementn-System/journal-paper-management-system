...
function ViewJournalArticle() {
    ...
    if (location.state) {
        ...
        article = articlesData.find(article => article._id === articleId);
                ...
                <div className="p-3">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 d-flex justify-content-end">
                            ...
                            />
                            <div className="ms-3">
                                <p className="m-0 fs-5 fw-bold">{user.firstName} {user.middleName} {user.lastName}</p>
                                <p className="fst-italic m-0 text-end">- {new Date(article.createdAt).toDateString()}</p>
                            </div>
                        </div>
                        <hr />
                        <div className="col-md-6">
                            <h5 className="fw-bold d-flex align-items-center"><PiArticleBold className="me-2" />Abstract</h5>
                        ...
                        <div className="col-md-5">
                            ...
                            {/* {article.authors.map((author, index) =>
                                <p key={index} className="p-0 ms-4 d-inline">{author.firstName} {author.lastName}</p>
                            )} */}
                            <hr />
